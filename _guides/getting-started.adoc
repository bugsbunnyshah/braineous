...
:url: https://github.com/bugsbunnyshah/braineous_dataplatform/raw/declarative_data_ingestion/releases/braineous-1.0.0-cr1/tutorials/braineous-tutorials.zip
